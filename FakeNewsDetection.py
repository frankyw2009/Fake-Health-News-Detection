...
data = train_politifact_dataset[0]
...
# plt.xlabel("epoch")
# plt.ylabel("accuracy")
# plt.title("Politifact Training Accuracy")
# plt.legend()  # 加图例
#
# # for x1, y1 in zip(x, y):
# #     plt.text(x1, y1, str(y1), ha='center', va='bottom', fontsize=16)
#
# # plt.savefig(os.path.join('Figures','politifact_training_graph.jpg'), dpi=350)
# plt.show()
#
